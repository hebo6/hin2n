...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig subnetRouteModelDaoConfig;

    private final N2NSettingModelDao n2NSettingModelDao;
    private final SubnetRouteModelDao subnetRouteModelDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        subnetRouteModelDaoConfig = daoConfigMap.get(SubnetRouteModelDao.class).clone();
        subnetRouteModelDaoConfig.initIdentityScope(type);

        n2NSettingModelDao = new N2NSettingModelDao(n2NSettingModelDaoConfig, this);
        subnetRouteModelDao = new SubnetRouteModelDao(subnetRouteModelDaoConfig, this);

        registerDao(N2NSettingModel.class, n2NSettingModelDao);
        registerDao(SubnetRouteModel.class, subnetRouteModelDao);
    }
    
    public void clear() {
        n2NSettingModelDaoConfig.clearIdentityScope();
        subnetRouteModelDaoConfig.clearIdentityScope();
    }
    ...
    public SubnetRouteModelDao getSubnetRouteModelDao() {
        return subnetRouteModelDao;
    }
